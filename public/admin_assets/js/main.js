...
$(function() {
  ...
  MINOVATE.global = {
    ...
    layout: function() {
        var defaultHeaderScheme = readCookie('defaultHeaderScheme') != null ? readCookie('defaultHeaderScheme') : 'scheme-drank',
            defaultNavbarScheme = readCookie('defaultNavbarScheme') != null ? readCookie('defaultNavbarScheme') : 'scheme-drank',
            defaultBrandingScheme = readCookie('defaultBrandingScheme') != null ? readCookie('defaultBrandingScheme') : 'scheme-drank',
            defaultColorScheme = readCookie('defaultColorScheme') != null ? readCookie('defaultColorScheme') : 'scheme-drank',
            defaultHeaderPosition = readCookie('fixedHeader') != null ? readCookie('fixedHeader') : 'header-fixed',
            defaultNavbarPosition = readCookie('aside-fixed') != null ? readCookie('aside-fixed') : 'aside-fixed',
          defaultRightbarVisibility = 'rightbar-hidden',
            defaultAppClasses = 'scheme-default default-scheme-color ' + defaultHeaderPosition + ' ' + defaultNavbarPosition + ' rightbar-hidden';

        if (defaultHeaderPosition == 'header-fixed') {
            $('#fixed-header').attr('checked', true);
        }

        if (defaultNavbarPosition == 'aside-fixed') {
            $('#fixed-aside').attr('checked', true);
        }
      ...
      $headerSchemeEl.on('click', function($event) {
        ...
        defaultHeaderScheme = scheme;
          ...
          eraseCookie('defaultHeaderScheme');
          createCookie('defaultHeaderScheme', scheme, 365);
      ...
      $brandingSchemeEl.on('click', function($event) {
        ...
        defaultBrandingScheme = scheme;
          ...
          eraseCookie('defaultBrandingScheme');
          createCookie('defaultBrandingScheme', scheme, 365);
      ...
      $sidebarSchemeEl.on('click', function($event) {
        ...
        defaultNavbarScheme = scheme;
          ...
          eraseCookie('defaultNavbarScheme');
          createCookie('defaultNavbarScheme', scheme, 365);
      ...
      $colorSchemeEl.on('click', function($event) {
        ...
        defaultColorScheme = scheme;
          ...
          eraseCookie('defaultColorScheme');
          createCookie('defaultColorScheme', scheme, 365);
      ...
      $fixedHeaderEl.change(function() {
        if ($body.hasClass('header-fixed')) {
            eraseCookie('fixedHeader');
            createCookie('fixedHeader', 'header-static', 365);
          $body.removeClass('header-fixed').addClass('header-static');
        } else {
            eraseCookie('fixedHeader');
            createCookie('fixedHeader', 'header-fixed', 365);
      ...
      $fixedAsideEl.change(function() {
        if ($body.hasClass('aside-fixed')) {
            eraseCookie('aside-fixed');
            createCookie('aside-fixed', 'aside-static', 365);
          $body.removeClass('aside-fixed').addClass('aside-static');
          $sidebar.removeClass('aside-fixed').addClass('aside-static');
        } else {
            eraseCookie('aside-fixed');
            createCookie('aside-fixed', 'aside-fixed', 365);
    ...
    collapse: function(){
      $collapseSidebarEl.on('click', function(e) {
        if ($app.hasClass('sidebar-sm')) {
            eraseCookie('sidebar-to-remove');
            createCookie('sidebar-to-remove', 'sidebar-sm', 365);

            eraseCookie('sidebar-to-add');
            createCookie('sidebar-to-add', 'sidebar-xs', 365);
          $app.removeClass('sidebar-sm').addClass('sidebar-xs');
        }
        else if ($app.hasClass('sidebar-xs')) {
            eraseCookie('sidebar-to-remove');
            createCookie('sidebar-to-remove', 'sidebar-xs', 365);
          ...
          $app.removeClass('sidebar-xs');
            ...
            eraseCookie('sidebar-to-add');
            createCookie('sidebar-to-add', 'sidebar-sm', 365);
  ...
  MINOVATE.documentOnReady = {
    ...
    setSidebar: function() {
      ...
      if ($app.hasClass('sidebar-xs-forced')) {
        ...
        var toRemove = readCookie('sidebar-to-remove') == null ? '' : readCookie('sidebar-to-remove');
        $app.removeClass(toRemove);

        var toAdd = readCookie('sidebar-to-add') == null ? '' : readCookie('sidebar-to-add');
        $app.addClass(toAdd);
