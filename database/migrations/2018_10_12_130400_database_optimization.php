    ...
    public function up()
    {
        ...
        try {
            Schema::table('users_social_meta', function (Blueprint $table) {
                $table->string('s_key', 500)->default('')->change();
                $table->string('s_value', 500)->default('')->change();
            });
        ...
        try { \DB::unprepared('ALTER TABLE `users` ADD INDEX `tfa_token` (`tfa_token`);'); } catch (Exception $exception) {}
