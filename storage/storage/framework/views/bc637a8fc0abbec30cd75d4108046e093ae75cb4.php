        ...
        var table = $('#users-table').DataTable({
            ...
            "columns": [
                ...
                {"data": "created_at"},
                {
                    ...
                    "render": function (data, type, row, meta) {
                        return '<a href="' + row['show'] + '" target="_blank" class="btn btn-xs btn-default"><i class="glyphicon glyphicon-eye-open"></i> <?php echo e(__('show')); ?></a> <a href="' + row['edit'] + '" target="_blank" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i> <?php echo e(__('edit')); ?></a>';
                    }
                }
            ],
            "aoColumnDefs": [
            ...
            initComplete: function () {
                this.api().columns([0, 1, 2]).every(function () {
                    ...
                    $(input).appendTo($(column.footer()).empty()).attr('placeholder', '<?php echo e(__('search ...')); ?>')
                        .on('keyup', function () {
