                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="sidebarNav" class="panel-collapse collapse in" role="tabpanel">
                            <div class="panel-body">
                                ...
                                ==================================================== -->
                                <ul id="navigation">
                                    <li class="<?php echo e((Route::is('admin') ? 'active' : '')); ?>"><a href="<?php echo e(route('admin')); ?>"><i class="fa fa-dashboard"></i>
                                            <span><?php echo e(__('Dashboard')); ?></span></a>
                                    </li>
                                    <li class="<?php echo e((Route::is('admin.users.*') ? 'active' : '')); ?>"><a href="<?php echo e(route('admin.users.index')); ?>"><i class="fa fa-users"></i>
                                    ...
                                    <li class="<?php echo e((Route::is('admin.deposits.*') ? 'active' : '')); ?>"><a href="<?php echo e(route('admin.deposits.index')); ?>"><i class="fa fa-suitcase"></i>
                                    ...
                                    <li class="<?php echo e((Route::is('admin.requests.*') ? 'active' : '')); ?>"><a href="<?php echo e(route('admin.requests.index')); ?>"><i
                                    ...
                                    <li class="<?php echo e((Route::is('admin.transactions.*') ? 'active' : '')); ?>"><a href="<?php echo e(route('admin.transactions.index')); ?>"><i class="fa fa-cubes"></i>
                                    ...
                                    <li class="<?php echo e((Route::is('admin.statistic') ? 'active' : '')); ?>"><a href="<?php echo e(route('admin.statistic')); ?>"><i class="fa fa-bar-chart-o"></i>
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            <li class="<?php echo e((Route::is('admin.settings.*') ? 'active' : '')); ?>"><a href="<?php echo e(route('admin.settings.index')); ?>"><i
                                            ...
                                            <li class="<?php echo e((Route::is('admin.tpl_texts.*') ? 'active' : '')); ?>"><a href="<?php echo e(route('admin.tpl_texts.index')); ?>"><i
                                    ...
                                    <li class="<?php echo e((Route::is('admin.referral.*') ? 'active' : '')); ?>"><a href="<?php echo e(route('admin.referral.index')); ?>"><i class="fa fa-sitemap"></i>
                                            <span><?php echo e(__('Affiliate plans')); ?></span>
                                        </a>
                                    </li>
                                    <li class="<?php echo e((Route::is('admin.backup.*') ? 'active' : '')); ?>"><a
                                                href="<?php echo e(route('admin.backup.index')); ?>"><i class="fa fa-hdd-o"></i>
                                            <span><?php echo e(__('Backups')); ?></span></a>
                                    </li>
                                    <?php if(auth()->check() && auth()->user()->hasRole('root')): ?>
                                    <li>
                                        <a role="button"><i class="fa fa-bullhorn"></i>
                                            <span><?php echo e(__('Accruals')); ?></span></a>
                                        <ul>
                                            <li class="<?php echo e((Route::is('admin.jobs.round') ? 'active' : '')); ?>"><a href="<?php echo e(route('admin.jobs.round')); ?>"><i class=""></i>
                                                    <span><?php echo e(__('Queued jobs')); ?></span>
                                                </a>
                                            </li>
                                            <li class="<?php echo e((Route::is('admin.jobs.failed') ? 'active' : '')); ?>"><a href="<?php echo e(route('admin.jobs.failed')); ?>"><i class=""></i>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-4 control-label">
                                            <div class="onoffswitch greensea">
                                                <?php if(\App\Models\Setting::getValue('site-on') == 'on'): ?>
                                                ...
                                                <label class="onoffswitch-label" for="switch-on"
                                                       onclick="location.href='<?php echo e(route('admin.settings.change',['key'=>'site-on'])); ?>';">
                                                    <span class="onoffswitch-inner"></span>
                                                    <span class="onoffswitch-switch"></span>
                                                </label>
