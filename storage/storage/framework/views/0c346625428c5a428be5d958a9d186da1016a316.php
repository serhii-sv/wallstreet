                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-9">
                            <?php if(!empty(getTopPartner())): ?>
                                ...
                                <?php echo e(__('invited')); ?>

                                <strong><?php echo e(getTopPartner()['referrals_amount']); ?></strong> <?php echo e(__('customers')); ?>
            ...
            <div class="card">
                <div class="front bg-slategray">
                    ...
                    <div class="row">
                        ...
                        <!-- col -->
                        <div class="col-xs-8">
                            <p class="text-elg text-strong mb-0"><?php echo e(getVisitorsOnline()); ?></p>
                            <span><?php echo e(__('Users online')); ?></span>
                        </div>
                        <!-- /col -->
                    </div>
                    <!-- /row -->
                ...
                <div class="back front bg-slategray">
                    ...
                    <div class="row">
                        ...
                        <!-- col -->
                        <div class="col-xs-8">
                            <p class="text-elg text-strong mb-0"><?php echo e(getMembersOnline()); ?></p>
                            <span><?php echo e(__('authorized')); ?></span>
                        </div>
                        <!-- /col -->
                    </div>
                    <!-- /row -->
