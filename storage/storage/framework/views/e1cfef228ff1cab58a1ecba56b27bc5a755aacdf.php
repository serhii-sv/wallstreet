                ...
                <div class="tile-body">
                    ...
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('admin.user-tasks.tasks.update', ['id' => $task->id])); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="reward_amount" type="number" class="form-control" name="reward_amount" value="<?php echo e($task->reward_amount); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="duration" type="number" class="form-control" name="duration" value="<?php echo e($task->duration); ?>">
                            </div>
                        </div>
                        ...
                        <?php $__currentLoopData = \App\Models\UserTasks\TaskScopes::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scope): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            $existsScopeInfo = $task->actions()
                                ->where('task_scope_id', $scope->id)
                                ->first();
                            ?>
                            <div class="form-group">
                                <label for="scope_<?php echo e($scope->id); ?>" class="col-md-4 control-label"><?php echo e($scope->getScopeDescription()); ?></label>
                                <div class="col-md-6">
                                    <input id="scope_<?php echo e($scope->id); ?>" type="text" class="form-control" name="scope[<?php echo e($scope->id); ?>]" value="<?php echo e(null !== $existsScopeInfo ? $existsScopeInfo->source_address : ''); ?>" placeholder="https://example.com/page">
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
