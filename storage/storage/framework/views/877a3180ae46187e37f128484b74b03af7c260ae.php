...
<?php else: ?>
    <a href="<?php echo e($existsScope1Info->source_address); ?>" target="_blank"><?php echo e($existsScope1Info->source_address); ?></a>
<?php endif; ?>
</div>
...
<div class="form-group">
    ...
    <?php else: ?>
        <a href="<?php echo e($existsScope2Info->source_address); ?>" target="_blank"><?php echo e($existsScope2Info->source_address); ?></a>
    <?php endif; ?>
</div>
...
<div class="form-group">
    ...
    <?php else: ?>
        <a href="<?php echo e($existsScope6Info->source_address); ?>" target="_blank"><?php echo e($existsScope6Info->source_address); ?></a>
    <?php endif; ?>
</div>
...
<div class="form-group">
    ...
    <?php else: ?>
        <a href="<?php echo e($existsScope7Info->source_address); ?>" target="_blank"><?php echo e($existsScope7Info->source_address); ?></a>
    <?php endif; ?>
</div>
...
<?php if(!isset($existsScope3Info)): ?>
    <div class="col-md-6">
        <input id="scope3" type="text" class="form-control" name="scope[vk_page_subscription]" value="" placeholder="https://vk.com/hyipium">
    </div>
<?php else: ?>
    <a href="<?php echo e($existsScope3Info->source_address); ?>" target="_blank"><?php echo e($existsScope3Info->source_address); ?></a>
<?php endif; ?>
</div>
...
<?php else: ?>
    <a href="<?php echo e($existsScope4Info->source_address); ?>" target="_blank"><?php echo e($existsScope4Info->source_address); ?></a>
<?php endif; ?>
</div>
...
<div class="form-group">
    ...
    <?php else: ?>
        <?php echo e($existsScope8Info->source_address); ?>
...
<div class="form-group">
    ...
    <?php else: ?>
        <?php echo e($existsScope9Info->source_address); ?>
...
<div class="form-group">
    ...
    <?php if(!isset($existsScope10Info)): ?>
        <div class="col-md-6">
    ...
    <?php else: ?>
        <?php echo e($existsScope10Info->source_address); ?>
