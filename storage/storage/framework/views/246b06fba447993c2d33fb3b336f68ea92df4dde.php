<?php $__env->startSection('title'); ?>
    <?php echo e(__('Available task elements')); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrumbs'); ?>
    <li> <?php echo e(__('Available task elements')); ?></li>
<?php $__env->stopSection(); ?>
        ...
        <div class="col-md-12">
            ...
            <section class="tile">
                ...
                <div class="tile-header dvd dvd-btm">
                    <h1 class="custom-font"><?php echo e(__('Available task elements')); ?></h1>
                    <ul class="controls">
...
<?php $__env->startPush('load-scripts'); ?>
    <script>
        ...
        var table = $('#events').width('100%').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": '<?php echo e(route('admin.user-tasks.available_elements.datatable')); ?>',
            "columns": [
