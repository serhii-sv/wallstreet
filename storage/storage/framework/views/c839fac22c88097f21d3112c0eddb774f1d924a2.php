            ...
            <div class="et_pb_column et_pb_column_4_4  et_pb_column_1 et-last-child">
                ...
                <div class="et_pb_text et_pb_module et_pb_bg_layout_light et_pb_text_align_left et_animated et_pb_text_0">
                    ...
                    <div class="et_pb_text_inner">
                        ...
                        <h2 style="text-align: center;"><strong><?php echo e(__('Reviews')); ?></strong></h2>
                ...
                <div class="et_pb_text et_pb_module et_pb_bg_layout_light et_pb_text_align_left  et_pb_text_1">
                    ...
                    <div class="et_pb_text_inner">
                        ...
                        <?php $__currentLoopData = getCustomerReviews(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <p style="font-weight: bold;"><?php echo e($review['name']); ?>:</p>
                            <p><?php echo e($review['text']); ?></p>
                            <?php echo e(!empty($review['video']) ? $review['video'] : ''); ?>

                            <p><?php echo e($review['created_at']); ?></p>
                            <hr>
