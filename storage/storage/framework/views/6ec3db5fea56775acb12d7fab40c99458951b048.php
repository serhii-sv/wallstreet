...
<?php $__env->startSection('breadcrumbs'); ?>
    <li> <?php echo e(__('Transactions')); ?></li>
<?php $__env->stopSection(); ?>
...
<?php $__env->startPush('load-scripts'); ?>
    <script>
        ...
        var table = $('#transactions-table').DataTable({
            ...
            "serverSide": true,
            "order": [[5, "desc"]],
            "ajax": '<?php echo e(route('admin.transactions.dtdata')); ?>',
            "columns": [
                {"data": "user.login"},
                ...
                {"data": "created_at"},
                {
                    ...
                    "render": function (data, type, row, meta) {
                        return '<a href="/admin/transactions/' + row['id'] + '" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-eye-open"></i> <?php echo e(__('show')); ?></a>';
                    }
                }
            ],
            "aoColumnDefs": [
