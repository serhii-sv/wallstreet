        ...
        success: function (data) {
          ...
          if ($data['status'] == 'good') {
            ...
            if ($notification_count == 0) {
              ...
              $("#notifications-dropdown").append('<li><a class="black-text" href="" style="display: flex; align-items: flex-start">' +
                  ' <span class="material-icons icon-bg-circle red small " style="display: block;">notifications_none</span>' +
