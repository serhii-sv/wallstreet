        ...
        <a href="{{ route('customer.main') }}" class="modal-window__close" title="{{ __('Back') }}"></a>
            ...
            <div class="col-md-8">
                <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                    {{ csrf_field() }}
                    <h4 class="form__title form__title--line"><span>{{ __('Registration') }}</span></h4>
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        <label for="name" class="form__title"><span>{{ __('Name') }} *</span></label>
                    ...
                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                        <label for="email" class="form__title"><span>{{ __('E-Mail Address') }} *</span></label>
                    ...
                    <div class="form-group{{ $errors->has('login') ? ' has-error' : '' }}">
                        <label for="login" class="form__title"><span>{{ __('Login name') }}</span></label>
                    ...
                    <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                        <label for="password" class="form__title"><span>{{ __('Password') }} *</span></label>
                    ...
                    <div class="form-group">
                        <label for="password-confirm"
                               class="form__title"><span>{{ __('Confirm Password') }} *</span></label>
                    ...
                    <div class="form-group" style="margin-left:15px; margin-top: 15px">
                        ...
                        <label for="agreement" style="margin-left:10px; margin-top: 15px">{{ __('I agree with') }} <a
                                    href="/agreement">{{ __('User agreement') }}</a> *</label>
