                ...
                <div id="validations" class="card card-tabs">
                    <div class="card-content">
                        ...
                        <div id="view-validations">
                            ...
                            <div class="card">
                                <div class="card-content">
                                    <form class="formValidate" action="{{ route('products.store') }}" id="formValidate" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row" id="main-view">
                                            <div class="row mt-2">
                                                <div class="input-field col s12">
                                                    <label for="slug">Slug*</label>
                                                    <input id="slug" name="slug" type="text" data-error=".errorTxt1" value="{{ old('slug') }}">
                                                </div>
                                                <div class="input-field col s12">
                                                ...
                                                <div class="input-field col s12">
                                                    ...
                                                    <input id="in_stock" name="in_stock" type="number" data-error=".errorTxt1" value="{{ old('in_stock') }}">
                                                </div>
                                                <div class="input-field col s12">
                                                    <label for="price">Цена*</label>
                                                    <input id="price" name="price" type="number" step="0.1" data-error=".errorTxt1" value="{{ old('price') }}">
                                                </div>
                                                <div class="col s12">
