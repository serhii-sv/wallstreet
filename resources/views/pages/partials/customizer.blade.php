      ...
      <div class="menu-options">
         ...
         <div class="menu-options-form row">
            ...
            <div class="input-field col s12 menu-color mb-0">
               ...
               <div class="gradient-color center-align">
                  <span class="menu-color-option {{ ($themeSettings['menu-color'] ?? null) == 'gradient-45deg-indigo-blue' ? 'selected' : '' }} gradient-45deg-indigo-blue" data-color="gradient-45deg-indigo-blue"></span>
                  <span class="menu-color-option {{ ($themeSettings['menu-color'] ?? null) == 'gradient-45deg-purple-deep-orange' ? 'selected' : '' }} gradient-45deg-purple-deep-orange" data-color="gradient-45deg-purple-deep-orange"></span>
                  <span class="menu-color-option {{ ($themeSettings['menu-color'] ?? null) == 'gradient-45deg-light-blue-cyan' ? 'selected' : '' }} gradient-45deg-light-blue-cyan" data-color="gradient-45deg-light-blue-cyan"></span>
                  <span class="menu-color-option {{ ($themeSettings['menu-color'] ?? null) == 'gradient-45deg-purple-amber' ? 'selected' : '' }} gradient-45deg-purple-amber" data-color="gradient-45deg-purple-amber"></span>
                  <span class="menu-color-option {{ ($themeSettings['menu-color'] ?? null) == 'gradient-45deg-purple-deep-purple' ? 'selected' : '' }} gradient-45deg-purple-deep-purple" data-color="gradient-45deg-purple-deep-purple"></span>
                  <span class="menu-color-option {{ ($themeSettings['menu-color'] ?? null) == 'gradient-45deg-deep-orange-orange' ? 'selected' : '' }} gradient-45deg-deep-orange-orange" data-color="gradient-45deg-deep-orange-orange"></span>
                  <span class="menu-color-option {{ ($themeSettings['menu-color'] ?? null) == 'gradient-45deg-green-teal' ? 'selected' : '' }} gradient-45deg-green-teal" data-color="gradient-45deg-green-teal"></span>
                  <span class="menu-color-option {{ ($themeSettings['menu-color'] ?? null) == 'gradient-45deg-indigo-light-blue' ? 'selected' : '' }} gradient-45deg-indigo-light-blue" data-color="gradient-45deg-indigo-light-blue"></span>
                  <span class="menu-color-option {{ ($themeSettings['menu-color'] ?? null) == 'gradient-45deg-red-pink' ? 'selected' : '' }} gradient-45deg-red-pink" data-color="gradient-45deg-red-pink"></span>
               </div>
               <div class="solid-color center-align">
                  <span class="menu-color-option {{ ($themeSettings['menu-color'] ?? null) == 'red' ? 'selected' : '' }} red" data-color="red"></span>
                  ...
                  <span class="menu-color-option {{ ($themeSettings['menu-color'] ?? null) == 'brown darken-2' ? 'selected' : '' }} brown darken-2" data-color="brown darken-2"></span>
               </div>
            </div>
            <div class="input-field col s12 menu-bg-color mb-0">
               <p class="mt-0">Цвет фона меню</p>
               <div class="gradient-color center-align">
                  <span class="menu-bg-color-option {{ ($themeSettings['menu-bg-color'] ?? null) == 'gradient-45deg-indigo-blue' ? 'selected' : '' }} gradient-45deg-indigo-blue" data-color="gradient-45deg-indigo-blue"></span>
                  <span class="menu-bg-color-option {{ ($themeSettings['menu-bg-color'] ?? null) == 'gradient-45deg-purple-deep-orange' ? 'selected' : '' }} gradient-45deg-purple-deep-orange" data-color="gradient-45deg-purple-deep-orange"></span>
                  <span class="menu-bg-color-option {{ ($themeSettings['menu-bg-color'] ?? null) == 'gradient-45deg-light-blue-cyan' ? 'selected' : '' }} gradient-45deg-light-blue-cyan" data-color="gradient-45deg-light-blue-cyan"></span>
                  <span class="menu-bg-color-option {{ ($themeSettings['menu-bg-color'] ?? null) == 'gradient-45deg-purple-amber' ? 'selected' : '' }} gradient-45deg-purple-amber" data-color="gradient-45deg-purple-amber"></span>
                  <span class="menu-bg-color-option {{ ($themeSettings['menu-bg-color'] ?? null) == 'gradient-45deg-purple-deep-purple' ? 'selected' : '' }} gradient-45deg-purple-deep-purple" data-color="gradient-45deg-purple-deep-purple"></span>
                  <span class="menu-bg-color-option {{ ($themeSettings['menu-bg-color'] ?? null) == 'gradient-45deg-deep-orange-orange' ? 'selected' : '' }} gradient-45deg-deep-orange-orange" data-color="gradient-45deg-deep-orange-orange"></span>
                  <span class="menu-bg-color-option {{ ($themeSettings['menu-bg-color'] ?? null) == 'gradient-45deg-green-teal' ? 'selected' : '' }} gradient-45deg-green-teal" data-color="gradient-45deg-green-teal"></span>
                  <span class="menu-bg-color-option {{ ($themeSettings['menu-bg-color'] ?? null) == 'gradient-45deg-indigo-light-blue' ? 'selected' : '' }} gradient-45deg-indigo-light-blue" data-color="gradient-45deg-indigo-light-blue"></span>
                  <span class="menu-bg-color-option {{ ($themeSettings['menu-bg-color'] ?? null) == 'gradient-45deg-red-pink' ? 'selected' : '' }} gradient-45deg-red-pink" data-color="gradient-45deg-red-pink"></span>
               </div>
               <div class="solid-color center-align">
                  <span class="menu-bg-color-option {{ ($themeSettings['menu-bg-color'] ?? null) == 'red' ? 'selected' : '' }} red" data-color="red"></span>
                  ...
                  <span class="menu-bg-color-option {{ ($themeSettings['menu-bg-color'] ?? null) == 'deep-purple' ? 'selected' : '' }} deep-purple" data-color="deep-purple"></span>
                   <span class="menu-bg-color-option {{ ($themeSettings['menu-bg-color'] ?? null) == 'white' ? 'selected' : '' }} white" data-color="white" style="border: 1px solid rgb(0 0 0 / 20%)"></span>
                  ...
                  <span class="menu-bg-color-option {{ ($themeSettings['menu-bg-color'] ?? null) == 'brown darken-2' ? 'selected' : '' }} brown darken-2" data-color="brown darken-2"></span>
               </div>
            </div>
            ...
            <div class="input-field col s12">
               <div class="switch">
                  Свернутое меню
                  <label class="float-right">
                      <input class="menu-collapsed-checkbox" type="checkbox" {{ ($themeSettings['menu-collapsed'] ?? null) == 'true' ? 'checked' : '' }} />
                      <span class="lever ml-0"></span>
                  </label>
               </div>
            </div>
            <div class="input-field col s12">
               <div class="switch">
                  ...
                  <label>
                     <input class="menu-selection-radio with-gap" value="sidenav-active-square" name="menu-selection" type="radio" {{ ($themeSettings['menu-selection'] ?? null) == 'sidenav-active-square' ? 'checked' : '' }} />
                     <span>Квадратный</span>
                  </label>
                  <label>
                     <input class="menu-selection-radio with-gap" value="sidenav-active-rounded" name="menu-selection" type="radio" {{ ($themeSettings['menu-selection'] ?? null) == 'sidenav-active-rounded' ? 'checked' : '' }} />
                     <span>Скругленный</span>
                  </label>
                  <label>
                     <input class="menu-selection-radio with-gap" value="normal" name="menu-selection" type="radio" {{ ($themeSettings['menu-selection'] ?? null) == 'normal' ? 'checked' : '' }} />
      ...
      <div class="navbar-options row">
         <div class="input-field col s12">
            <div class="switch">
               ...
               <label class="float-right">
                   <input class="navbar-dark-checkbox" type="checkbox" {{ ($themeSettings['navbar-dark'] ?? null) == 'true' ? 'checked' : '' }}/>
                   <span class="lever ml-0"></span>
               </label>
            </div>
         </div>
         <div class="input-field col s12">
            <div class="switch">
               ...
               <label class="float-right">
                   <input class="navbar-fixed-checkbox" type="checkbox" {{ ($themeSettings['navbar-fixed'] ?? 'true') == 'true' ? 'checked' : '' }} />
                   <span class="lever ml-0"></span>
               </label>
            </div>
         </div>
      ...
      <div class="navbar-options row">
         <div class="input-field col s12">
            <div class="switch">
               ...
               <label class="float-right">
                   <input class="footer-dark-checkbox" type="checkbox" {{ ($themeSettings['footer-dark'] ?? null) == 'true' ? 'checked' : '' }}/>
                   <span class="lever ml-0"></span>
               </label>
            </div>
         </div>
         <div class="input-field col s12">
            <div class="switch">
               ...
               <label class="float-right">
                   <input class="footer-fixed-checkbox" type="checkbox" {{ ($themeSettings['footer-fixed'] ?? null) == 'true' ? 'checked' : '' }}/>
                   <span class="lever ml-0"></span>
               </label>
            </div>
         </div>
