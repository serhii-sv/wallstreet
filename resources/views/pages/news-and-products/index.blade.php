        ...
        <div class="row">
            <div class="col s12">
                <ul class="tabs text-center">
                    <li class="tab col m3" style="width: 50%"><a class="active" href="#news">Новости</a></li>
                    <li class="tab col m3" style="width: 50%"><a href="#products">Продукты</a></li>
                </ul>
            </div>
            <div id="news" class="col s12">
                <a href="{{ route('news.create') }}" class="btn float-right mt-2">Добавить новость</a>
            ...
            <div id="products" class="col s12">
                <a href="{{ route('products.create') }}" class="btn float-right mt-2">Добавить продукт</a>
                                            ...
                                            <div class="card-content">
                                                ...
                                                <div class="display-flex flex-wrap justify-content-center">
                                                    ...
                                                    <a href="{{ route('products.edit', $product) }}"
                                                       class="mt-2 waves-effect waves-light gradient-45deg-deep-purple-blue btn btn-block z-depth-4">Показать</a>
                                                    <a href="{{ route('products.destroy', $product) }}"
                                                       class="mt-2 waves-effect waves-light gradient-45deg-deep-red-pink btn btn-block z-depth-4 delete">Удалить</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
