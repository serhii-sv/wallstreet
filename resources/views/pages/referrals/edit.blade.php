                            ...
                            <form class="formValidate" action="{{ route('referrals.update', $referral) }}" id="formValidate" method="post">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <input id="level" name="level" type="number" data-error=".errorTxt1" value="{{ $referral->level }}">
                                        <small class="errorTxt1"></small>
                                    </div>
                                    <div class="input-field col s12">
                                        <label for="percent">Процент *</label>
                                        <input id="percent" type="number" name="percent" data-error=".errorTxt2" value="{{ $referral->percent }}">
