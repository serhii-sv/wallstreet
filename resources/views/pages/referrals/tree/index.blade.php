...
{{-- page title --}}
@section('title', 'Реферальное дерево')
      ...
      <div id="basic-tabs" class="card card card-default scrollspy">
        <div class="card-content">
          <div class="display-flex justify-content-between">
            <h4 class="card-title">Дерево рефералов</h4>
          </div>
          <div class="row">
            <div class="col s12">
              <div class="row">
                  ...
                  <table style="width:100%; height:400px;">
                    <tr>
                      <td style="vertical-align: central; text-align: center;">
                        <iframe src="{{ route('referrals.reftree') }}" style="width:100%; height: 500px;border: 1px solid #ebebeb;"></iframe>
                      </td>
                    </tr>
                  </table>
                </div>
