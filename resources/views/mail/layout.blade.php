...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Email from Luminex</title>
    ...
    <style type="text/css">
        ...
        @media only screen and (max-width: 640px) {
            ...
            img[class=banner] {width: 240px!important;height:220px!important;}
        ...
        @media only screen and (max-width: 480px) {
            ...
            img[class=banner] {width: 150px!important;height:140px!important;}
  ...
  <body>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td width="100%" align="left" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 13px;color: #282828" st-content="preheader">
                            Can't see this Email? View it in your <a href="#" style="text-decoration: none; color: #fbc800">Browser </a>
                          </td>
                        </tr>
                        <!-- Spacing -->
                        <tr>
          ...
          <td>
            <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
              <tbody>
                <tr>
                  <td width="100%">
                    <table width="600" bgcolor="#fbc800" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                      <tbody>
                        <tr>
                          <td>
                            <!-- logo -->
                            <table bgcolor="#fbc800" width="140" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                              <tbody>
                                <tr>
                                  <td width="140" height="50" align="center">
                                    <div class="imgpop">
                                      <a target="_blank" href="https://luminex.biz">
                                        <img src="https://luminex.biz/img/logo/logo.png" alt="" border="0" height="40" style="display:block; border:none; outline:none; text-decoration:none;">
                                      </a>
                                    </div>
                                  </td>
                                </tr>
                            ...
                            <!-- end of logo -->
                            <!-- start of menu -->
                            <table bgcolor="#fbc800" width="250" height="50" border="0" align="right" valign="middle" cellpadding="0" cellspacing="0" border="0" class="devicewidth">
                              <tbody>
                                <tr>
                                  <td height="50" align="center" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 13px;color: #282828" st-content="menu">
                                    <a href="https://luminex.biz/" style="color: #282828;text-decoration: none;">HOME</a>
                                    &nbsp;&nbsp;&nbsp;
                                    <a href="https://luminex.biz/contact" style="color: #282828;text-decoration: none;">CONTACT US</a>
                                    &nbsp;&nbsp;&nbsp;
                                  </td>
                                </tr>
                              </tbody>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td width="280" height="140" align="center" class="devicewidth">
                                    <img src="https://luminex.biz/img/header-img.png" alt="" border="0" width="280" style="display:block; border:none; outline:none; text-decoration:none;" class="col2img">
                                  </td>
                                </tr>
                                <!-- /image -->
                              </tbody>
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #282828; text-align:left; line-height: 24px;">
                                            INVESTMENTS IN CRYPTOCURRENCY AND FOREX
                                          </td>
                                        </tr>
                                        <!-- end of title -->
                                        <!-- Spacing -->
                                        ...
                                        <tr>
                                          <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #889098; text-align:left; line-height: 24px;">
                                            Our future is fully automated technologies. This also applies to the cryptocurrency trade.
                                          </td>
                                        </tr>
                                        <!-- end of content -->
                                        <!-- Spacing -->
                                        ...
                                        <tr>
                                          <td>
                                            <table width="120" height="32" bgcolor="#fbc800" align="left" valign="middle" border="0" cellpadding="0" cellspacing="0" style="border-radius:3px;" st-button="learnmore">
                                              <tbody>
                                                <tr>
                                                ...
                                                <tr>
                                                  <td height="14" align="center" valign="middle" style="font-family: Helvetica, Arial, sans-serif; font-size: 13px; font-weight:bold;color: #ffffff; text-align:center; line-height: 14px; ; -webkit-text-size-adjust:none;" st-title="fulltext-btn">
                                                    <a style="text-decoration: none;color: #282828; text-align:center;" href="https://luminex.biz">Learn More</a>
                                                  </td>
                                                </tr>
                                                <tr>
                                                  <td height="9" align="center" style="font-size:1px; line-height:1px;">&nbsp;</td>
                          ...
                          <td>
                            ...
                            <table width="280" align="right" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                              <tbody>
                                ...
                                <tr>
                                  <td width="280" height="140" align="center" class="devicewidth">
                                    <img src="https://luminex.biz/img/mosaic/profit.png" alt="" border="0" width="280" style="display:block; border:none; outline:none; text-decoration:none;" class="col2img">
                                  </td>
                                </tr>
                                <!-- /image -->
                              </tbody>
                                  ...
                                  <td>
                                    <table width="280" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                      <tbody>
                                        ...
                                        <tr>
                                          <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #282828; text-align:left; line-height: 24px;">
                                            Profit 1.5% per day for 180 days
                                          </td>
                                        </tr>
                                        <!-- end of title -->
                                        <!-- Spacing -->
    ...
    <!-- <td align="center" st-image="banner-image">
       <div class="imgpop">
          <a target="_blank" href="#"><img width="160" border="0" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" src="https://luminex.biz/img/logo/logo.png" class="banner"></a>
       </div>
    </td>
 </tr>
</tbody>
          ...
          <td>
            <table width="600" bgcolor="#eacb3c" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
              <tbody>
                <tr>
                  <td width="100%">
                    <table bgcolor="#fbc800" width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                      <tbody>
                        <!-- Spacing -->
                        <tr>
                              ...
                              <tbody>
                                <tr>
                                  <td width="43" height="43" align="center">
                                    <div class="imgpop">
                                      <a target="_blank" href="https://t.me/joinchat/KbehfRDwnET-NUGKaxjcJg">
                                        <img src="https://luminex.biz/img/telegram.png" alt="" border="0" width="43" height="43" style="display:block; border:none; outline:none; text-decoration:none;">
                                      </a>
                                    </div>
                                  </td>
                                  <td align="left" width="20" style="font-size:1px; line-height:1px;">&nbsp;</td>
                                  <td align="center" width="50" height="43">
                                    <a target="_blank" style="color: #282828;" href="https://t.me/joinchat/KbehfRDwnET-NUGKaxjcJg">Join us in Telegram</a>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
